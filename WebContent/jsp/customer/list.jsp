...
<script type="text/javascript">
	$(function() {
		...
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"001"},function(data){
			...
			$("#cust_induxtry option[value='${model.baseDictIndustry.dict_id}']").prop("selected","selected");
		},"json");
	});
</script>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>客户级别：</TD>
													<TD>
														<select id="cust_level" name="baseDictLevle.dict_id">
															<option value="">--请选择--</option>
														</select>
													</TD>
													<TD>所属行业：</TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="totalCount" /></B>]条记录,第[<B><s:property value="totalPage" /></B>]页
												,每页显示
